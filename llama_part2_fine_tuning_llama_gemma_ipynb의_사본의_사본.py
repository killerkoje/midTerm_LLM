# -*- coding: utf-8 -*-
"""llama_part2_Fine Tuning_llama_gemma.ipynb의 사본의 사본

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ar3jGtzOzC-VN8y-p-DmhZyNkHkvwyK3
"""
...
def extract_response_llama3(question):
    ...
    outputs = pipe(
        ...
        temperature=0.1,                 # 샘플링의 온도 설정: 낮은 온도는 자유도를 주지 않음 (0보다 크고1보다 작아야함)ㅌ
